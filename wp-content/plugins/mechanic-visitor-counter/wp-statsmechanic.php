...
<p><label for="<?php echo $this->get_field_id('hits_view'); ?>"><?php _e('Enable Lượt Xem display? ', 'wp-statsmechanic'); ?><input type="checkbox" class="checkbox" <?php checked( $instance['hits_view'], 'on' ); ?> id="<?php echo $this->get_field_id('hits_view'); ?>" name="<?php echo $this->get_field_name('hits_view'); ?>" /></label></p>
<p><label for="<?php echo $this->get_field_id('totalhits_view'); ?>"><?php _e('Enable Tổng Lượt Xem display? ', 'wp-statsmechanic'); ?><input type="checkbox" class="checkbox" <?php checked( $instance['totalhits_view'], 'on' ); ?> id="<?php echo $this->get_field_id('totalhits_view'); ?>" name="<?php echo $this->get_field_name('totalhits_view'); ?>" /></label></p>
...
<div id='mvcwid' style='font-size:2; text-align:<?php echo $align ?>;color:<?php echo $fontcolor ?>;'>
	...
	<div id="mvctable">
            ...
            <?php } ?>
            <?php if ($hitsview) { ?>
            <tr><td style='font-size:2; text-align:<?php echo $align ?>;color:<?php echo $fontcolor ?>;'><?php echo $imghits ?> <?php _e('Lượt Xem Hôm Nay :', 'wp-statsmechanic');?> <?php echo $hits ?></td></tr>
            <?php } ?>
            <?php if ($totalhitsview) { ?>
            <tr><td style='font-size:2; text-align:<?php echo $align ?>;color:<?php echo $fontcolor ?>;'><?php echo $imgtotalhits ?> <?php _e('Tổng Lượt Xem :','wp-statsmechanic');?> <?php if ($hits_start==NULL) { 
					echo $totalhits ;
			}else{
            ...
            <?php } ?>
            <?php if ($onlineview) { ?>
            <tr><td style='font-size:2; text-align:<?php echo $align ?>;color:<?php echo $fontcolor ?>;'><?php echo $imgonline ?> <?php _e("Đang Xem :", 'wp-statsmechanic');?> <?php echo $pengunjungonline ?></td></tr>
            <?php } ?>
            </table>
    	</div>
        <?php if ($ipaddress) { ?>
        <div id="mvcip"><?php _e('IP Của Bạn:', 'wp-statsmechanic'); ?> <?php echo $ip ?></div>
        <?php } ?>
		<?php if ($stime) { ?>
