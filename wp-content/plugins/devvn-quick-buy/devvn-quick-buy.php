                            ...
                            <div class="devvn-popup-content-right">
                                <form class="devvn_cusstom_info" id="devvn_cusstom_info" method="post">
                                    <div class="popup-customer-info">
                                        ...
                                        <?php else:?>
                                            <?php
                                            $default_state_arg = get_option('devvn_woo_district');
                                            $default_state = '';
                                            if($default_state_arg && !empty($default_state_arg)){
                                                $default_state = isset($default_state_arg['tinhthanh_default']) ? $default_state_arg['tinhthanh_default'] : '';
                                            }
                                            ?>
                                            <div class="popup-customer-info-group">
                                                <div class="popup-customer-info-item-3-13">
                                                    <select class="customer-location" name="customer-location" id="devvn_city">
                                                        <?php foreach($vn_states as $k=>$v):?>
                                                            <option value="<?php echo $k;?>" <?php selected($k,$default_state,true);?>><?php echo $v;?></option>
                                                        <?php endforeach;?>
                                                    </select>
                                                </div>
